...
- `memory_gb = 11.3`
- `num_steps = 169`
- `description = layers=1, mask=<last>, lam=-1.75, wo_scale=0.12, lam_max=0.75, lam_w_init=zero, lam_w_scale=0.05, blend=1.0, q2_scale=1.0, y2norm=False, y2center=False, batch=2**15`

## Config

- `USE_DIFF_ATTN = True`
- `DIFF_ATTN_LAST_LAYERS = 1`
- `DIFF_ATTN_LAYER_MASK = <last>`
